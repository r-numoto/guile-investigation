...
> ⚠️ **コスト削減上の重要な注意点:** `jswf` CloudFormation スタックは GUILE ではなく JswfPlayer のために作られたインフラ。GUILE を廃止してもこのスタックが JswfPlayer のために必要な可能性がある。削除前に JswfPlayer の稼働状況を必ず確認すること。
