...
| サービス名 | 広告フォーマット | 主なリソース |
|---|---|---|
| **GUILE** | インタースティシャル広告（静止画・HTML、フルスクリーン型） | guile-interstitial, is-elb, cdn-guile など |
| **admovie** | 動画広告配信 | admovie-elb01/02, admovie-sonicmoov-elb01/02, ElastiCache(admovie) など |
...
> ⚠️ admovie の ElastiCache クラスターは現在も稼働中のため、admovie が完全廃止済みかどうかは別途確認が必要。
...
| スタック名 | ステータス | 作成日 |
|---|---|---|
| `jswf` | CREATE_COMPLETE | 2014-03-03 |
| `StackSet-TechorusCloudPortalRole-*` | UPDATE_COMPLETE | 2024-09-03 |
| `StackSet-NHNTechorusSupportIAMRole-*` | UPDATE_COMPLETE | 2024-09-03 |
